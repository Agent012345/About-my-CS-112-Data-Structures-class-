...
public class CyberCrimeInvestigationTest {
   ...
   public void testSearch() { 
      CyberCrimeInvestigation newInvestigation = new CyberCrimeInvestigation();
      newInvestigation.initializeTable("hackerTest.in");

      Hacker targetHacker = newInvestigation.search("Hacker6313");

      assertEquals("{Suspect: Hacker6313, Num Incidents: 2}", targetHacker);
