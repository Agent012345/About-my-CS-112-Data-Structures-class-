...
public class BSTDictionary {
    ...
    public ArrayList<WordNode> levelOrder() {
        ...
        Queue<WordNode> wordNodesQueue = new Queue<>();

        wordNodesQueue.enqueue(root);

        while (!wordNodesQueue.isEmpty()){
            WordNode currentNode = wordNodesQueue.dequeue();
            wordNodes.add(currentNode);

            if (currentNode.getLeft() != null){
                wordNodesQueue.enqueue(currentNode.getLeft());
            }

            if (currentNode.getRight() != null){
                wordNodesQueue.enqueue(currentNode.getRight());
            }
